...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Home MisterNT Blogger </title>
...
<div id="wrapper" class="clearfix">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                <div id="logo" class="nobottomborder">
                    <a href="index.html" class="standard-logo" data-dark-logo="images/logo.jpg"><img src="logo.jpg" alt="MisterNT Logo"></a>
                    <a href="index.html" class="retina-logo" data-dark-logo="images/logo.jpg"><img src="logo.jpg" alt="MisterNT Logo"></a>
                </div><!-- #logo end -->
    ...
    <section id="content">
        ...
        <div class="content-wrap nopadding">
            ...
            <a class="button button-full center button-light button-white">
                <div class="container clearfix">
    ...
    <footer id="footer" class="dark">
        ...
        <div id="copyrights">
            ...
            <div class="container clearfix">
                ...
                <div class="center">
                    Copyrights &copy; <?php echo data('Y');?> All Rights Reserved by MisterNT.<br>
